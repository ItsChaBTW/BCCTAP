...
<head>
    ...
    <title>Events Management - BCCTAP</title>
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-grow main-content px-4 py-8">
            <div class="flex flex-col md:flex-row justify-between items-center mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-primary mb-2">Events Management</h1>
                    <p class="text-gray-600">Create, edit and manage attendance events</p>
                </div>
                <a href="create.php" class="mt-4 md:mt-0 bg-gradient-primary hover:opacity-90 text-white font-medium py-2 px-4 rounded-lg transition duration-300 flex items-center">
                ...
                <div class="overflow-x-auto">
                    ...
                    <?php else: ?>
                        <div class="text-center py-16">
                            ...
                            <div class="mt-6">
                                <a href="create.php" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-gradient-primary hover:opacity-90">
            ...
            <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div class="mt-4">
                        <a href="../reports/attendance.php" class="text-primary hover:text-red-700 font-medium text-sm flex items-center">
                            View Records
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div class="mt-4">
                        <a href="../qrcodes/index.php" class="text-secondary hover:text-orange-700 font-medium text-sm flex items-center">
                            Manage QR Codes
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                            </svg>
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div class="mt-4">
                        <a href="../users/index.php" class="text-yellow-500 hover:text-yellow-700 font-medium text-sm flex items-center">
                            Manage Students
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                            </svg>
